...
while not done:
    if  t <= n0:
        ...
        x0 = np.vstack([x0,(state[:-1]).reshape(1,n)])
...
colorpalette = sns.color_palette("Paired") # colorblind
...
plt.plot(timeFromN0, xnarx_all[qoi:,0], label = label4,color=colors_hex[4])
plt.plot(timeFromN0, xma_all[qoi:,0], label = label5,color=colors_hex[5])
...
plt.plot(timeFromN0, xnarx_all[qoi:,1], label = label4,color=colors_hex[4])
plt.plot(timeFromN0, xma_all[qoi:,1], label = label5,color=colors_hex[5])
plt.legend(loc="upper right", borderaxespad=0.1,prop={'size': 14})
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel('Simulation step',fontsize=14)
...
plt.plot(timeFromN0, xnarx_all[qoi:,2], label = label4,color=colors_hex[4])
plt.plot(timeFromN0, xma_all[qoi:,2], label = label5,color=colors_hex[5])
plt.legend(loc="upper right", borderaxespad=0.1,prop={'size': 14})
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel('Simulation step',fontsize=14)
...
plt.plot(timeFromN0, xnarx_all[qoi:,3], label = label4,color=colors_hex[4])
plt.plot(timeFromN0, xma_all[qoi:,3], label = label5,color=colors_hex[5])
plt.legend(loc="upper right", borderaxespad=0.1,prop={'size': 14})
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel('Simulation step',fontsize=14)
...
plt.plot(timeFromN0, xnarx_all[qoi:,4], label = label4,color=colors_hex[4])
plt.plot(timeFromN0, xma_all[qoi:,4], label = label5,color=colors_hex[5])
plt.legend(loc="upper right", borderaxespad=0.1,prop={'size': 14})
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel('Simulation step',fontsize=14)
