...
class MPC:
    ...
    docstring
    """
    def __init__(self, Uub=None, Ulb=None, Xub_soft=None, Xlb_soft=None, Xub_hard=None, Xlb_hard=None, Mub=None, Mlb=None, n = 2, nm0 = 2, num_horizon=5, Uslop=0.005, Usmooth=0.01):
        """
    ...
    def set_cost(self, z0, ulast, A, B, C, q=10, qh=50, r=0.01):
        """
        Cost = U*H*U' + f'*U
